...
export default class Results extends Component {
    ...
    getResults(){
        ...
        fetch('https://django-cloudrun-ed7wjo25ka-ew.a.run.app/result')
            ...
            .then(data => {
                this.setState({"result": data["results"], "fetched": true, "qualifiers": data["results"].slice(0, 10)})
                console.log(data)
            })
    }
    ...
    displayQualifier(){
        ...
        while (this.array_contains(this.state["displayed"], qualifiers[num]) === true){
    ...
    ett_resultat(){
        return (
            <div>
                ...
                <br/>
                <button onClick={this.displayQualifier.bind(this)}>BIG RED BUTTON</button>
            </div>
        )
    }
